...
pub use pixtuoid_core::layout::{
    furniture_def, Bounds, Facing, FurnitureDef, PlantKind, PodDecor, Point, SceneLayout,
    WallDecor, Waypoint, WaypointKind, DESK_GAP_X, DESK_GAP_Y, DESK_H, DESK_W, MAX_VISIBLE_DESKS,
